...
(defun problem-008 ()
  (let ((series "73167176531330624919225119674426574742355349194934
    ...
    (largest-product-in-series series)))



(defun largest-product-in-series (series)
...
;; (PROBLEM-008)
;; took 784 microseconds (0.000784 seconds) to run.
;; During that period, and with 8 available CPU cores,
;;      784 microseconds (0.000784 seconds) were spent in user mode
;;        4 microseconds (0.000004 seconds) were spent in system mode
;;  93,792 bytes of memory allocated.
